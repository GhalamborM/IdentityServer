...
{
    private static PostConfigureLicenseKey CreateSut(IEnumerable<KeyValuePair<string, string>> configValues) =>
    ...
    {
        var sut = CreateSut([
            new("Duende:IdentityServer:LicenseKey", "product-key"),
            new("Duende:LicenseKey", "shared-key"),
        ]);
        var options = new IdentityServerConfigurationOptions();
    ...
    {
        var sut = CreateSut([
            new("Duende:IdentityServer:LicenseKey", "config-key"),
        ]);
        var options = new IdentityServerConfigurationOptions { LicenseKey = "imperative-key" };
    ...
    {
        var sut = CreateSut([
            new("Duende:IdentityServer:LicenseKey", emptyValue),
            new("Duende:LicenseKey", emptyValue),
        ]);
        var options = new IdentityServerConfigurationOptions();
    ...
    {
        var sut = CreateSut([
            new("Duende:LicenseKey", "  some-key  "),
        ]);
        var options = new IdentityServerConfigurationOptions();
