...
public class DefaultClaimsService : IClaimsService
{
    ...
    /// <inheritdoc/>
    public virtual async Task<IReadOnlyCollection<Claim>> GetIdentityTokenClaimsAsync(ClaimsPrincipal subject, ResourceValidationResult resources, bool includeAllIdentityClaims, ValidatedRequest request, Ct ct)
    {
    ...
    /// <inheritdoc/>
    public virtual async Task<IReadOnlyCollection<Claim>> GetAccessTokenClaimsAsync(ClaimsPrincipal subject, ResourceValidationResult resourceResult, ValidatedRequest request, Ct ct)
    {
